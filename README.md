...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `prosimo` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-prosimo
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-prosimo/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-prosimo/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-prosimo_darwin_amd64_v1
│   └── pulumi-resource-prosimo
├── pulumi-prosimo_darwin_arm64
│   └── pulumi-resource-prosimo
├── pulumi-prosimo_linux_amd64_v1
│   └── pulumi-resource-prosimo
├── pulumi-prosimo_linux_arm64
│   └── pulumi-resource-prosimo
├── pulumi-prosimo_windows_amd64_v1
│   └── pulumi-resource-prosimo.exe
└── pulumi-prosimo_windows_arm64
    └── pulumi-resource-prosimo.exe
```
